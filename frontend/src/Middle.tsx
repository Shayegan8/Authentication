        ...
        Elementa = <div className="register">
            <div className="register-form-card">
                <div className="register-form-title">
                    {loc.pathname == "/register" ? "Create your account" : "Sign in to your account"}
                </div>
                <br></br>
                    ...
                    onClick={async () => {
                        if (verificationRefs.current) {
                            ...
                            if (loc.pathname == "/register/validation/jwt")
                                res = await registerValidationSubmit(inputi)
                            else
                                res = await loginValidationSubmit(inputi)
                            const slidechips = slideshit.current

                            if (slidechips) {
                                if (!res) {
                                    slidechips.innerText = loc.pathname == "/register/validation/jwt" ? "Successfully regustered!" : "Successfully Logged in!"
                                    navigate("/")
                                    console.log("Gambis")
                                } else {
                                    if (loc.pathname == "/register/validation/jwt")
                                        slidechips.innerText = "Register failed, redirecting..."
                                    else
